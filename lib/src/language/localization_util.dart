...
class LocalizationUtil {
  ...
  static String getLocaleName(BuildContext context, Locale locale) {
    final languageNames = <Locale, String>{
      ...
      localeAmharic: AppLocalizations.of(context)!.amharic,
      localTigrigna: AppLocalizations.of(context)!.tgrigna,
      localAfanOromo: AppLocalizations.of(context)!.afanOromo,
    };
